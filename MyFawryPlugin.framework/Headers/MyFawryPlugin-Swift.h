...
#ifndef MYFAWRYPLUGIN_SWIFT_H
#define MYFAWRYPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyFawryPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13MyFawryPlugin20FawryBaseModelObject")
@interface FawryBaseModelObject : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13MyFawryPlugin17CardTokenizerInfo")
@interface CardTokenizerInfo : FawryBaseModelObject
...
SWIFT_CLASS("_TtC13MyFawryPlugin16DatePickerDialog")
...
SWIFT_CLASS("_TtC13MyFawryPlugin5Fawry")
@interface Fawry : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC13MyFawryPlugin18FawryPluginStartup")
@interface FawryPluginStartup : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC13MyFawryPlugin4Item")
@interface Item : FawryBaseModelObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC13MyFawryPlugin7Popover")
...
SWIFT_CLASS("_TtC13MyFawryPlugin12SCLAlertView")
...
SWIFT_CLASS("_TtC13MyFawryPlugin9SCLButton")
...
SWIFT_CLASS("_TtC13MyFawryPlugin15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(MyFawryPlugin)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(MyFawryPlugin)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(MyFawryPlugin)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(MyFawryPlugin)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(MyFawryPlugin)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC13MyFawryPlugin12TaskDelegate")
...
SWIFT_CLASS("_TtC13MyFawryPlugin10ThemeStyle")
...
SWIFT_CLASS("_TtC13MyFawryPlugin13cardTokenizer")
@interface cardTokenizer : FawryBaseModelObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
